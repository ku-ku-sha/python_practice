...
print(f'\nВсего {count_lucky_tickets(6)} 6-значных счастливых билетов.')
print(f'\nВсего {count_lucky_tickets(8)} 8-значных счастливых билетов.')
print(f'\nВсего {count_lucky_tickets(14)} 14-значных счастливых билетов.')
